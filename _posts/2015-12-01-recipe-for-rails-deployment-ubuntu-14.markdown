...
```bash
  bundle install
```
2. create/edit file config/unicorn.rb ([unicorn.rb exapmle](2015-12-01-recipe-for-rails-deployment-ubuntu-14/unicorn.rb))
3. edit config/deploy.rb ([deploy.rb exapmle](2015-12-01-recipe-for-rails-deployment-ubuntu-14/deploy.rb))
